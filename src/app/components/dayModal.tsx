...
const DayModal: React.FC<{
  ...
  events
    ...
    const handleEnterPress = async () => {
      ...
      const selectedOption = eventOptions.find(option => option.value === inputValue);
            ...
            <Flex gap='10px' wrap vertical>
              {inputVisible ? (
                ...
                <Flex gap='10px' wrap>
                  ...
                  />
                  <Tag onClick={showInput} color={colorPickerValue} icon={<PlusOutlined />}>
                    New Tag
                  </Tag>
                </Flex>
              )}
              ...
              <Flex gap='10px' wrap>
                ...
                >
                  <Input size="large" placeholder="Create/Select Event"
                    onPressEnter={handleEnterPress}
                    addonAfter={
                      <Popconfirm
                        title='Pick an emoji'
                        description={<EmojiPicker theme={Theme.DARK} autoFocusSearch={true} />}
                        onConfirm={confirm}
                        onCancel={cancel}
                        okText=''
                        cancelText=''
